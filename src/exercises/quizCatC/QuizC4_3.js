...
export const QuizC4_3 = {
        header:['Proszę przeczytać tekst i — zgodnie z podanym przykładem — połączyć tytuły z odpowiednimi fragmentami tekstu.',
    ''],
        template:{  point:1 },
            row:[
               ...
               ['Koniec studiów','Poza tym kobiety w wojsku, tak jak mężczyźni, mogą się szkolić i awansować. Ta oferta była atrakcyjna dla dziewczyny po studiach, dlatego się zgłosiła. Jednak okazało się, że musi zdać kilka egzaminów: z angielskiego, wiedzy ogólnej oraz ze sprawności fizycznej.'],
               ['Kariera w wojsku','Kiedy Ania się dostała, została skierowana na szkolenie. Przez siedem miesięcy musiała robić wszystko na rozkaz. Ktoś, kto do tej pory sam o sobie decydował, nagle nic nie może. To był trudny czas. Często płakała, ale nie zrezygnowała. Została zawodowym żołnierzem i jest zadowolona.']
            ],
            answer:['A','C','E','B','F','D']
    }