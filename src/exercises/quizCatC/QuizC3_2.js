...
export const QuizC3_2 = {
    header:['Proszę — zgodnie z podanym przykładem — połączyć wypowiedzi z kolumny I z wypowiedziami z kolumny II. Odpowiedzi proszę wpisać do tabelki.',
            ''],
    template:{  point:0.5 },
        row:[
           ['DOM/ MIESZKANIE','Trzypokojowe w centrum miasta sprzedam lub zamienię na większe.'],
           ...
           ['ROZRYWKA','Włoski dla początkujących i zaawansowanych, konwersacje.'],
           ['PRACA','Sprzedam komórkę z ładowarką. Stan bardzo dobry. Atrakcyjna cena!'],
           ['OGRÓD','Oddam w dobre ręce rasowe szczeniaki. 4 tygodnie, szczepione.']
        ],
        answer:['A','J','F','K','B','I','D','G','C','H','E']
}